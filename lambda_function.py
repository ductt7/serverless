...
table = dynamodb.Table('Orders')               #update your DDB table name
...
def process_order(order):
    ...
    response = sqs.send_message(
        QueueUrl='https://sqs.us-west-1.amazonaws.com/YourAccountID/MyProcessingQ.fifo',  # Use the correct SQS queue URL
